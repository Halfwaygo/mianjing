  ...
  <div class="migu-content newExam">
    ...
    <el-form :inline="true" size="small" :rules="rules2">
      <el-form-item label="试卷名称：" style="margin-right:50px;">
        ...
        <el-input v-else class="w290" v-model="examPaperRequest.paperName" placeholder="000请在这里输入试卷名称，不得超过20个字" @blur="EditPaperName"></el-input>
      </el-form-item>
  ...
  export default {
    ...
    created () {
      ...
      if(self.$route.query.id){
        ...
        self.getExamDetailInfo({paperId:self.$route.query.id}).then(res => {
