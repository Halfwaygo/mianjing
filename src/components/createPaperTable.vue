    ...
    <div>
        ...
        <div class='table-wrapper' ref = "tableWrap">
            <el-table :class="{'table-empty': sourceList.length == 0 }" :data="sourceList" @sort-change="handleSortChange" style='width:100%;' ref='table'>
                ...
                <el-table-column label="单选" prop="name">
                </el-table-column>
                <el-table-column label="多选" prop="YestIncUser">
                </el-table-column>
            ...
            <edit-exam-model v-model="editExamModel" :rowData="rowData"></edit-exam-model>
